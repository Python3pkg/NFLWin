# -*- coding: utf-8 -*-
#
# NFLWin documentation build configuration file, created by
...
from nflwin import __version__
version = __version__
...
latex_documents = [
    (master_doc, 'NFLWin.tex', 'NFLWin Documentation',
     'Andrew Schechtman-Rook', 'manual'),
]
...
man_pages = [
    (master_doc, 'nflwin', 'NFLWin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NFLWin', 'NFLWin Documentation',
     author, 'NFLWin', 'One line description of project.',
     'Miscellaneous'),
]
